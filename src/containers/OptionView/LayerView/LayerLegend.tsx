...
import { TILE_LAYER_LEGEND_COLORS } from '../../../constants/staticArcResources';
...
const LayerLegend = (props: any) => {
  ...
  const tryToLoadLegend = () => {
    ...
    const imgSrc = TILE_LAYER_LEGEND_COLORS[props.activeLayerInfoTitle];

    newItem = (
      <div className='tile-layer-legend-row'>
        <div className='tile-layer-legend-text'>LOW</div>
        <img src={imgSrc} className='tile-layer-legend-image' />
